...
/* In every utility function you add that needs to use variables 
   ...
   the globals in your function as SG_MONITOR_G(variable).  You are 
   encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/

#ifdef ZTS
#define SG_MONITOR_G(v) TSRMG(sg_monitor_globals_id, zend_sg_monitor_globals *, v)
#else
#define SG_MONITOR_G(v) (sg_monitor_globals.v)
#endif
